...
subtitle: Just for fun and because we can.
date: 2016-12-15
...
```{r}
fldr <- here::here("posts", "2016-12-15-interactive-and-styled-middle-earth-map", "data")
...
shp_points_to_geoj <- function(file = "Cities.shp"){
  ...
  names(outp) <- str_to_title(names(outp))
