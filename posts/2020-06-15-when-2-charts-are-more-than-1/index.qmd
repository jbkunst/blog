...
subtitle: …Or when two half chart are more than one, or maybe 'The love between the streamgraph and stack column chart'… In this post we’ll review some ideas in the chart used by Financial Times in it’s Coronavirus tracker, and how we can replicate it in R using highcharter package.
date: 2020-06-24
categories: 
  - data-visualization
  - highcharts
